...
const VideoTitle = ({ id, title, overview }) => {
  return (
    <div className="w-full aspect-video pt-[15%] pl-16 md:top-14 absolute bg-gradient-to-t from-black">
      <h1 className="relative w-4/5 md:w-full top-11 right-10 md:top-0 md:right-0 text-lg md:text-4xl font-bold text-white text">
        {title}
      </h1>
